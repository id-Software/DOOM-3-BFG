...
void main( PS_IN fragment, out PS_OUT result )
{
	...
	float Y = t_Y.Sample( LinearSampler, fragment.texcoord0.xy ).x;
	float Cr = t_Cr.Sample( LinearSampler, fragment.texcoord0.xy ).x;
	float Cb = t_Cb.Sample( LinearSampler, fragment.texcoord0.xy ).x;
