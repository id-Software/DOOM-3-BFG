...
inline ImDrawList*      GetForegroundDrawList( ImGuiWindow* )
{
	ImGuiContext& g = *GImGui;    // This seemingly unnecessary wrapper simplifies compatibility between the 'master' and 'docking' branches.
